...
if __name__ == "__main__":
    ...
    #         create_backtest_result_table(result_db_connection)
    #         create_ticker_table(ohlcv_db_connection)
    #         schedule.every().hour.at("00:00").do(fetch_glassnode_to_db,ohlcv_db_connection,GLASSNODE_API,"1h",True)
    #         schedule.every().day.at("00:30:00").do(fetch_glassnode_to_db,ohlcv_db_connection,GLASSNODE_API,"24h",True)
    ...
    #         uvicorn.run("run_backtest:app", host=args.host, port=args.port, workers=args.workers)
